	...
	<div id="wrap" class="table">
		...
		<table width="100%" class="nb">
			...
			<c:forEach items="${ list }" var="dto">
				<tr>
					<td>${dto.t_no }</td>
					<td><a href="TB_content_view?t_no=${dto.t_no }">${dto.t_title }</a></td>
					<td>${dto.t_writer }</td>
					<td>${fname }</td>
					<td>${dto.t_hit }</td>
				</tr>
			...
			<tr>
				<td align="center">
					<!-- 처음 이전 링크 --> <c:if test="${pg>block}">
						<a href="TB_list?pg=${fromPage-1}"><img
							src="<c:url value='resources/img/arrowsleft.gif'/>"></a>
						<a href="TB_list?pg=${pg-1}"><img
